...
public class ResistanceStone extends SingleInfusedBlockBase {
    protected static Effect EFFECTTYPE = Effects.RESISTANCE;
    protected static int DURATION = 2;
    protected static int AMPLIFIER = 2;

    public ResistanceStone() {
        ...
        SetEffect(TextFormatting.BLUE + "Resistance");
