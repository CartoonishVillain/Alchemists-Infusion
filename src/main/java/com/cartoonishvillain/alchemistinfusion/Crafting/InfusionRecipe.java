...
public class InfusionRecipe {
    ...
    public static ArrayList<ArrayList<ItemStack>> ParseTier1Recipe(Item item){
        ...
        if ("alchemistinfusion:alchemical_bowl".equals(parser)) {
            ...
            stacks.add(new ArrayList<>(Arrays.asList(new ItemStack(item), new ItemStack(BlockItemRegistry.PRIMEDPAVEMENT_ITEM.get()), new ItemStack(Items.FLINT_AND_STEEL), new ItemStack(Items.GOLD_INGOT, 4), new ItemStack(Items.LAPIS_LAZULI, 4), new ItemStack(Items.DIAMOND), new ItemStack(BlockItemRegistry.ACTIVATEDPAVEMENT_ITEM.get()))));
    ...
    public static ArrayList<ArrayList<ItemStack>> ParseTier2Recipe(Item item){
        ...
        switch(parser){
            ...
            case "alchemistinfusion:alchemical_fragment_cast":
                ...
                stacks.add(new ArrayList<>(Arrays.asList(new ItemStack(item), new ItemStack(Items.STICKY_PISTON, 3), new ItemStack(Items.PISTON, 3), new ItemStack(ItemRegistry.BASEFRAGMENT.get()), new ItemStack(ItemRegistry.SLOWDIGDUST.get()), new ItemStack(ItemRegistry.RESTRICTIVEFRAGMENT.get()))));
                ...
                stacks.add(new ArrayList<>(Arrays.asList(new ItemStack(item), new ItemStack(Items.NETHER_WART, 2), new ItemStack(ItemRegistry.JUMPFRAGMENT.get()), new ItemStack(Items.IRON_BOOTS), new ItemStack(Items.NETHER_WART_BLOCK, 2), new ItemStack(Items.EMERALD), new ItemStack(ItemRegistry.LEAP_BOOTS.get()))));
