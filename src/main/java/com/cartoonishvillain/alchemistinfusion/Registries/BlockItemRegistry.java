...
public class BlockItemRegistry {
    ...
    public static final RegistryObject<Item> PRIMEDPAVEMENT_ITEM = BLOCKITEMS.register("primed_pavement", () -> new BlockItemBase(BlockRegistry.PRIMEDPAVEMENT.get(), new ArrayList<>(Arrays.asList(TextFormatting.RED + "Tier 1 Alchemical Infusion station", TextFormatting.GRAY + "Also the base for a majority of blocks!"))));
    public static final RegistryObject<Item> ACTIVATEDPAVEMENT_ITEM = BLOCKITEMS.register("activated_pavement", () -> new BlockItemBase(BlockRegistry.ACTIVATEDPAVEMENT.get(), new ArrayList<>(Arrays.asList(TextFormatting.BLUE + "Tier 2 Alchemical Infusion station! Use with an Infusion Rod for it's full potential"))));
    public static final RegistryObject<Item> ATTUNEDPAVEMENT_ITEM = BLOCKITEMS.register("attuned_pavement", () -> new BlockItemBase(BlockRegistry.ATTUNEDPAVEMENT.get(), new ArrayList<>(Arrays.asList(TextFormatting.GREEN + "Tier 3 Alchemical Infusion station! Use with an Attuned Infusion Rod for it's full potential"))));
